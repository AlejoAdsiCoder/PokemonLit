...
export class PokemonEvolution extends LitElement {
    ...
    static properties = {
        evolutions: { type: Array },  // Recibe las evoluciones como una propiedad
        pokemonName: { type: String }  // Recibe el nombre del Pokémon actual
    };
  ...
  static styles = css`
    /* Estilos de la página de evolución */
  `;
  ...
  render() {
    return html`
       <h2>Evolutions of ${this.pokemonName}:</h2>
        <ul>
